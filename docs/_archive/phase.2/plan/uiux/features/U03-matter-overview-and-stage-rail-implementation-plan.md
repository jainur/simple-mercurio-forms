# U03 Matter Overview and Stage Rail - UI UX Implementation Plan

## Objective
Deliver Matter Overview and Stage Rail with production-ready UX behavior and measurable outcomes.
...
1. Implement matter shell with persistent stage rail.
2. Build overview cards and deadline strip components.
3. Integrate blocker and risk APIs with retry-safe polling.
4. Implement side panel with publish-back and sync context.
5. Add tests for stage transitions reflected in UI state.
