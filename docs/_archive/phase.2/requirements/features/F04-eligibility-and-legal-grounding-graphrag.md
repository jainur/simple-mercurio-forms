# F04 Eligibility and Legal Grounding (GraphRAG) - Detailed Requirements

## Objective
Produce eligibility matrix with citations and evidence gaps

## In Scope
- Phase 2 implementation for Eligibility and Legal Grounding (GraphRAG)
...
1. The system must implement Eligibility and Legal Grounding (GraphRAG) flows aligned to Phase 2 state progression.
2. The system must expose stable APIs or integration contracts for: /reasoning /eligibility.
...
1. Produce requirement-level status matrix with confidence scores.
2. Attach legal citations for each recommendation and risk flag.
3. Generate missing evidence recommendations by requirement.
4. Support comparison of multiple procedures for ranking.
