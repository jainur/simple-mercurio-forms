# F06 Form Generation and Packet Assembly - Detailed Requirements

## Objective
Generate procedure forms (HTML and PDF) from approved data

## In Scope
- Phase 2 implementation for Form Generation and Packet Assembly
...
1. The system must implement Form Generation and Packet Assembly flows aligned to Phase 2 state progression.
2. The system must expose stable APIs or integration contracts for: /forms/generate /forms/{id}.
...
1. Generate form artifacts as HTML and PDF for each procedure template.
2. Populate fields from approved corrected extraction data.
3. Support operator corrections and regeneration of artifacts.
4. Mark form status transitions: generating, ready, approved, submitted.
