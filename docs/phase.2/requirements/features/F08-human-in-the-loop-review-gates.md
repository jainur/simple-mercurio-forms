# F08 Human-in-the-Loop Review Gates - Detailed Requirements

## Objective
Support extraction review, form review, and submission decision approvals

## In Scope
- Phase 2 implementation for Human-in-the-Loop Review Gates
...
1. The system must implement Human-in-the-Loop Review Gates flows aligned to Phase 2 state progression.
2. The system must expose stable APIs or integration contracts for: /extractions /forms/{id}/approve /submit-decision.
...
1. Provide extraction review endpoints with approve and correction flows.
2. Provide form review and approval endpoints with correction history.
3. Provide submit decision endpoint for online flow (submit or decline).
4. Enforce mandatory human approvals before irreversible steps.
