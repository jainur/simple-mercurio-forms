...
def to_field_values(form: EX17FormSchema) -> dict[str, Any]:
    ...
    fv["Casilla de verificación10"] = req.card_request_type == CardRequestTypeEnum.INITIAL_CARD
    fv["Casilla de verificación11"] = req.card_request_type == CardRequestTypeEnum.CARD_RENEWAL
    fv["Casilla de verificación12"] = req.card_request_type == CardRequestTypeEnum.DUPLICATE_LOSS_THEFT_DAMAGE_OR_DATA_CHANGE
